...
class SpellingBee(Task):
    """Letter-counting task: count occurrences of a letter in a word, using manual counting and Python verification."""

    def __init__(self, size: int = 1000, split: str = "train", **kwargs) -> None:
